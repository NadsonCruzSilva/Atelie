...
| **Regra de Negócio** | **Bloqueio Inadimplente:** Cliente com pendência ou >30 dias de atraso não abre nova OS. | **Limite Operacional:** Uma fábrica não pode ter mais de 10 ordens ativas. | **Programa de Fidelidade:** 10% de desconto na OS para clientes com 3 ou mais ordens finalizadas. |

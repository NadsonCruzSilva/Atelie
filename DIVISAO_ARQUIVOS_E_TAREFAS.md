...
* **3. Regra de Negócio (Programa de Fidelidade)**
  * **O que fazer:** Antes de abrir uma nova OS, o DAO deve consultar (`COUNT`) se o cliente possui 3 ou mais ordens de serviço com status 'FINALIZADA'. Se sim, a aplicação deve aplicar 10% de desconto no valor total da nova OS.
